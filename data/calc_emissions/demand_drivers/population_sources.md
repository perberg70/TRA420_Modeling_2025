...
- All annual values from 2023 through 2100 are linearly interpolated between the workbook's five-year time steps; 2023 is interpolated between the workbook's 2020 and 2025 columns so the dynamic demand model can use the 2023 electricity-demand base year.
